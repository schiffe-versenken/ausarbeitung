...
\begin{figure}
	...
	\subfigure[Schicht Level 1]{\resizebox{36mm}{!}{\includegraphics{figures/FullGridGeneral2}}}
	\subfigure[Schicht Level 2]{\resizebox{36mm}{!}{\includegraphics{figures/FullGridGeneral3}}}
	\subfigure[Schicht Level 3]{\resizebox{36mm}{!}{\includegraphics{figures/FullGridGeneral4}}}
...
\subsection{Volle Gitter Strategie}
\textbf{TODO Dennis}
%Ein Vorgehen, dass für beide Gitter Strategien sich als passend herausgestellt hat, ist die einmalige Berechnung der Gitterpunkte pro neu hinzukommender Schicht bzw. Diagonale (vgl. 2D Fall). Dann wird lediglich die Zugehörigkeit eines Punktes zu einer Schicht / Diagonalen berechnet. Alle Schichten / Diagonalen kleineren Levels werden natürlich vorher beschossen. Also kann deren Gesamtmenge an Zellen auf den Schussindex dieses Punktes hinzuaddiert werden. Es muss dann lediglich vermerkt werden, die wie vielte beschossene Zelle dieser Schicht / Diagonalen wir gerade beschießen. 
%Dabei bleibt uns die zuvor als notwendig erkannte Grundstruktur der Gitterschussstrategien erhalten. Also die Schicht- / Diagonalenweise Abarbeitung (vgl Abbildung ).
...
\begin{landscape}
	\includepdf[landscape=true]{figures/random-dimension.png}
    %\includegraphics[width=\paperwidth]{figures/random-dimension.png}
\end{landscape}
